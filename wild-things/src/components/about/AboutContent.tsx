          ...
          <div id="about_us" className="card">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                photography from his nature adventues provides great content for
                website development. This site is both an example of Martin's
                development work and a look inside his nature adventures with
                his business partner and wife, Rose.
                <br /> <br />
                ...
                <br />
                <br />
                For more information about Martin, Rose, or any place they have
                visited, please contact them at the contact page on this
                website.
                <br />
                <br />
